...
class SeoContract extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <View p={25}>
                <Text h4>قرارداد سئو</Text>

                <View mt={25} p={20} rounded={15} shadow>
                    <Text>قرار داد سئو و بهینه سازی </Text>
                    ...
                    <View flex mh={5}>
                        <Button flex h={40} bg={colors.orange} center bRadius={40} onPress={() => {
                            WebBrowser.openBrowserAsync(
                                'https://portal.vistaapp.ir/seo/' + this.props.project_id + '/pdf'
                            )
                        }}>
                            <Text color={colors.white} h5>pdf فایل قرارداد</Text>
                        </Button>
                    </View>
                </View>
            </View>
