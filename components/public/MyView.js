    ...
    return (
        <View {...props} style={
            [
                ...
                props.flexStart ? {justifyContent: 'flex-start'} : '',
                props.flexEnd ? {justifyContent: 'flex-end'} : '',
                props.flexCenter ? {justifyContent: 'center'} : '',
                props.spaceBetween ? {justifyContent: 'space-between'} : '',
                props.spaceAround ? {justifyContent: 'space-around'} : '',
                props.spaceEvenly ? {justifyContent: 'space-evenly'} : '',
                ...
                props.h ? {height: (props.h == 'full' ? height : (props.h == 'auto' ? 'auto' : (props.h >= 0 ? props.h : height + props.h)))} : '',
